  ...
  return (
    <div className="relative h-[70vh] min-h-120 flex flex-col items-center justify-center gap-6">
      <Particles
        ...
        refresh
      />
      <h1 className="relative mx-0 max-w-[43.5rem] pt-5 md:mx-auto md:px-4 md:py-2 text-balance text-left font-semibold tracking-tighter md:text-center text-5xl sm:text-7xl md:text-7xl lg:text-7xl">
